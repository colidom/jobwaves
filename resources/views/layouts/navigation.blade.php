                    ...
                    @can('create', App\Models\Vacancy::class)
                        <div class="flex items-center gap-4">
                            @if (auth()->user()->unreadNotifications->count() > 0)
                                ...
                                <a class="right-3 bg-sky-600 hover:bg-sky-600 rounded-full flex flex-col justify-center items-center text-sm font-extrabold relative p-1"
                            ...
                            @else
                                ...
                                <a class="right-3 bg-gray-200 rounded-full flex flex-col justify-center items-center text-sm font-extrabold relative p-1"
                                    href="{{ route('notifications') }}">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <span
                                        class="absolute top-0 right-8 -mt-1 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-red-100 bg-red-300 rounded-full">
                                        {{ auth()->user()->unreadNotifications->count() }}
                                    </span>
                                </a>
                            @endif
                    ...
                    <div class="flex items-center gap-4 mt-3">
                        @if (auth()->user()->unreadNotifications->count() > 0)
                            <div class="flex gap-2 items-center mt-3">
                                <!-- Ícono de campana cuando hay notificaciones -->
                                <a class="ml-7 bg-sky-600 hover:bg-sky-600 rounded-full flex flex-col justify-center items-center text-sm font-extrabold relative p-1"
                                    href="{{ route('notifications') }}">
                                    <div class="text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
